...
const unsigned int PrnCode::L1CAPrnInit[32] = {
...
const unsigned int PrnCode::L5IPrnInit[32] = {
...
const unsigned int PrnCode::L5QPrnInit[32] = {
...
const unsigned int PrnCode::L2CMPrnInit[32] = {
...
const unsigned int PrnCode::L2CLPrnInit[32] = {
...
const unsigned int PrnCode::B1IPrnInit[63] = {
...
const unsigned int PrnCode::B3IPrnInit[63] = {
...
const unsigned int PrnCode::B2aDPrnInit[63] = {
...
const unsigned int PrnCode::E5aIPrnInit[50] = {
...
const unsigned int PrnCode::E5aQPrnInit[50] = {
...
const unsigned int PrnCode::E5bIPrnInit[50] = {
...
const unsigned int PrnCode::E5bQPrnInit[50] = {
...
const int PrnCode::B1CDataTruncation[63] = {
 ...
 const int PrnCode::B1CDataPhaseDiff[63] = {
...
const int PrnCode::B1CPilotTruncation[63] = {
...
const int PrnCode::B1CPilotPhaseDiff[63] = {
...
const int PrnCode::L1CDataInsertIndex[63] = {
...
const int PrnCode::L1CDataPhaseDiff[63] = {
...
const int PrnCode::L1CPilotInsertIndex[63] = {
...
const int PrnCode::L1CPilotPhaseDiff[63] = {
...
const PrnAttribute PrnCode::PrnAttributes[] = {
...
PrnCode::PrnCode(GnssSystem System, int SignalIndex, int Svid)
{
...
int *PrnCode::GetGoldCode(unsigned int G1Init, unsigned int G1Poly, unsigned int G2Init, unsigned int G2Poly, int Length, int Depth, int ResetPos)
{
...
void PrnCode::LegendreSequence(int *Data, int Length)
{
	int i;
...
int *PrnCode::GetL1CWeil(int InsertIndex, int PhaseDiff)
{
...
int *PrnCode::GetB1CWeil(int TruncationPoint, int PhaseDiff)
{
...
int *PrnCode::GetMemorySequence(const unsigned int *BinarySequence, int SectorLength)
{
